...
function checkbook(theform)
{
    ...
    $.ajax({
        ...
        {
            $('#showmsg').html(t0.substring(1));
            if(t0.substring(0,1)==0){theform.username.value='';theform.content.value='';;$('#showmsg').html("<img src="+webdir+"skins/ylw/images/loading.gif>发布成功");setTimeout("window.location.href='?';","3000");}
        }
    });
    return false
}
